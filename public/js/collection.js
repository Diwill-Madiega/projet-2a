...
$(document).ready(function() {
    ...
    $addNewItem.on('click', function(e) {
        ...
        $newFormLi.append('<div class="col-md-2"><button type="button" class="btn btn-danger remove-item" style="margin: 10px 0px 10px 0px;"><i class="fas fa-trash"></i> Supprimer</button></div>');
